...
async function checkApiAccess() {
    try {
        ...
        const response = await fetch(`${API_ENDPOINT}reports_upper_air.php?territory=${territory}&date=${date}&period=${period}&time_period=${time_period}&variable=${variable}`);
        return response.ok;
    } catch (error) {
...
async function loadStationData() {
    ...
    try {
        ...
        if (periodType === 'monthly') {
            ...
            apiUrl = `${API_ENDPOINT}reports_upper_air.php?territory=${territory}&variable=${variable}&date=${monthDate}&period=${periodType}`;
        } else {
            apiUrl = `${API_ENDPOINT}reports_upper_air.php?territory=${territory}&variable=${variable}&date=${date}&period=${periodType}`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Load station data automatically
    loadStationData();
});
