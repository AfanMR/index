...
async function checkApiAccess() {
    try {
        ...
        const response = await fetch(`${API_ENDPOINT}gbon_land_surface_stations.php?territory=${territory}&date=${date}&period=${period}&time_period=${time_period}&variable=${variable}`);
        return response.ok;
    } catch (error) {
...
async function loadStationData() {
    ...
    try {
        ...
        if (periodType === 'monthly') {
            ...
            apiUrl = `${API_ENDPOINT}gbon_land_surface_stations.php?territory=${territory}&variable=${variable}&date=${monthDate}&period=${periodType}`;
        } else {
            apiUrl = `${API_ENDPOINT}gbon_land_surface_stations.php?territory=${territory}&variable=${variable}&date=${date}&period=${periodType}`;
