...
async function checkApiAccess() {
    try {
        ...
        const response = await fetch(`${API_ENDPOINT}gbon_upper_air_stations.php?territory=${territory}&date=${date}&period=${period}&variable=${variable}`);
        return response.ok;
    } catch (error) {
...
async function loadStationData() {
    ...
    try {
        ...
        if (periodType === 'monthly') {
            ...
            apiUrl = `${API_ENDPOINT}gbon_upper_air_stations.php?territory=${territory}&variable=${variable}&date=${monthDate}&period=${periodType}`;
        } else {
            apiUrl = `${API_ENDPOINT}gbon_upper_air_stations.php?territory=${territory}&variable=${variable}&date=${date}&period=${periodType}`;
        }
