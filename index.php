...
<section class="text-center mb-12 lg:mb-16">
    ...
    <div class="max-w-4xl mx-auto space-y-4 text-gray-600 leading-relaxed">
        ...
        <p class="text-sm sm:text-base animate-fade-in-up" style="animation-delay: 0.8s;">
            Currently, main modules are available for WIGOS Asia Pacific monitoring, covering various aspects of regional meteorological and climatological observations:
        </p>
    </div>
</section>

    <!-- Asia Pacific Basic Observing Network (APBON) -->
    ...
    <section class="animate-fade-in-up mb-12 lg:mb-16" style="animation-delay: 1s;">
        <div class="bg-gradient-to-r from-gray-600 to-gray-700 text-white px-6 py-4 rounded-t-lg">
            <h3 class="text-base lg:text-lg font-medium">Near-real-time NWP monitoring of Observing System Networks</h3>
        </div>
        <div class="bg-white p-6 lg:p-8 rounded-b-lg shadow-lg">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 max-w-5xl mx-auto">
                <!-- NWP Surface -->
                <a href="nwp/land_surface/index.php" class="monitoring-item group transform transition-all duration-300 hover:-translate-y-2">
                    <div class="w-44 lg:w-52 mx-auto h-32 lg:h-36 relative rounded-lg shadow-lg group-hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                    ...
                    <div class="text-center mt-4">
                        <h4 class="text-sm lg:text-base font-bold text-gray-800">Surface land observations</h4>
                    </div>
                </a>
                
                <!-- NWP Upper -->
                <a href="nwp/land_upper_air/index.php" class="monitoring-item group transform transition-all duration-300 hover:-translate-y-2">
                    <div class="w-44 lg:w-52 mx-auto h-32 lg:h-36 relative rounded-lg shadow-lg group-hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                    ...
                    <div class="text-center mt-4">
                        <h4 class="text-sm lg:text-base font-bold text-gray-800">Upper-air land observations</h4>
                    </div>
                </a>
                
                <!-- NWP Marine -->
                <a href="nwp/land_marine/index.php" class="monitoring-item group transform transition-all duration-300 hover:-translate-y-2">
                    <div class="w-44 lg:w-52 mx-auto h-32 lg:h-36 relative rounded-lg shadow-lg group-hover:shadow-xl transition-shadow duration-300 overflow-hidden">
                    ...
                    <div class="text-center mt-4">
                        <h4 class="text-sm lg:text-base font-bold text-gray-800">Marine Surface observations</h4>
                    </div>
                </a>
            </div>
        </div>
