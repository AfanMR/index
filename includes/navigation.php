...
$navigation_menu = [
    ...
    [
        ...
        'url' => '/gbon',
        'submenu' => [
            ['title' => 'Land Surface ', 'url' => '/gbon/land_surface/index.php'],
            ['title' => 'Land Upper Air ', 'url' => '/gbon/land_upper-air/index.php'],
        ]
    ],
    [
        'title' => 'NWP', 
        'url' => '/nwp',
        'submenu' => [
            ['title' => 'Land Surface ', 'url' => '/nwp/land_surface/index.php'],
            ['title' => 'Land Upper Air ', 'url' => '/nwp/land_upper_air/index.php'],
            ['title' => 'Land Marine ', 'url' => '#'],
        ]
    ],
    ...
    [
        ...
        'submenu' => [
            [
                ...
                'is_label' => true,
                'submenu' => [
                    ['title' => 'Land Surface', 'url' => '/reports/gbon/land-surface.php'],
                    ['title' => 'Upper Air', 'url' => '/reports/gbon/upper-air.php'],
                ]
            ],
        ]
    ],
...
<nav class="bg-gray-50 border-b border-gray-200 sticky top-0 z-50">
    <div class="container mx-auto px-4">
        ...
        <div id="nav-menu" class="hidden lg:flex lg:justify-between lg:items-center pb-4 lg:pb-0">
                                ...
                                <?php foreach ($menu['submenu'] as $submenu): ?>
                                    ...
                                    <li class="<?= isset($submenu['submenu']) ? 'relative dropdown-nested' : '' ?>">
                                        <?php if (isset($submenu['submenu'])): ?>
                                            <?php if (isset($submenu['is_label']) && $submenu['is_label']): ?>
                                                <!-- Label Text (Disabled) -->
                                                <div class="px-4 py-2 text-sm text-gray-500 font-medium bg-gray-100 border-b border-gray-200">
                                            ...
                                            <!-- Nested Dropdown -->
                                            <?php if (isset($submenu['is_label']) && $submenu['is_label']): ?>
                                                <!-- For label text, show submenu items directly below -->
            ...
            <!-- Right Menu (About, Support, Tickets, Monitoring Reports) -->
            <ul class="flex flex-col lg:flex-row lg:space-x-8 space-y-2 lg:space-y-0 mt-4 lg:mt-0">
                <?php 
                // Filter menu untuk sebelah kanan (About, Support, Tickets, Monitoring Reports)
                $right_menu = array_filter($navigation_menu, function($menu) {
                    return in_array(strtolower($menu['title']), ['about', 'support', 'tickets', 'monitoring reports']);
                });
                ?>
                <?php foreach ($right_menu as $menu): ?>
                    ...
                    <li class="<?= isset($menu['submenu']) ? 'relative dropdown' : '' ?>">
                        <?php if (isset($menu['submenu'])): ?>
                            ...
                            <!-- Dropdown Submenu -->
                            <ul class="dropdown-menu hidden lg:absolute lg:top-full lg:right-0 lg:mt-1 lg:w-64 lg:bg-white lg:border lg:border-gray-200 lg:rounded-md lg:shadow-lg bg-gray-50 pl-4 lg:pl-0 z-50">
                                <?php foreach ($menu['submenu'] as $submenu): ?>
                                    <?php 
                                    $is_submenu_active = function_exists('isActivePage') ? isActivePage($submenu['url']) : false;
                                    $submenu_active_class = $is_submenu_active 
                                    ...
                                    <li class="<?= isset($submenu['submenu']) ? 'relative dropdown-nested' : '' ?>">
                                        <?php if (isset($submenu['submenu'])): ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <!-- Nested Dropdown -->
                                                <ul class="dropdown-nested-menu hidden lg:absolute lg:top-0 lg:right-full lg:mr-1 lg:w-48 lg:bg-white lg:border lg:border-gray-200 lg:rounded-md lg:shadow-lg bg-gray-100 pl-4 lg:pl-0 z-60">
                                                    <?php foreach ($submenu['submenu'] as $nested_submenu): ?>
                                                        <?php 
                                                        $is_nested_active = function_exists('isActivePage') ? isActivePage($nested_submenu['url']) : false;
                                                        $nested_active_class = $is_nested_active 
