...
<main class="container mx-auto px-4 py-8 lg:py-12 max-w-7xl">
    ...
    <div class="text-center mb-12">
        <h1 class="text-3xl lg:text-4xl text-bmkg-blue font-bold mb-4">
            About RWC Indonesian Dashboard
        </h1>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-8 mb-12">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="prose prose-lg max-w-none text-gray-700">
                <p class="mb-4">
                    The RWC (Regional Weather Centre) Indonesia Dashboard is a comprehensive platform specifically developed to monitor the performance of all meteorological and climatological observation components in the Asia Pacific region, covering Regional WMO V and surrounding areas.
                </p>
                <p class="mb-4">
